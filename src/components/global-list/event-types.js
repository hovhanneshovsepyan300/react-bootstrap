        ...
        return(
            <div className="col col-12 col-sm-12 col-md-6 col_right">
                ...
                <div className={`box_form ${companies.length > 10? 'scrolleffect':''}`}>
                    {addItem && <ListMap   placeholder="event type" save={this.adding} deleteItem={this.cancelAdding} />}
                ...
                <Modal show={showModal}  onHide={this.handleShowModal} centered>
                    ...
                    <Modal.Body>event type with name {lastDeletedItem} successfuly deleted</Modal.Body>
